    ...
    socket.on('send_mensaje',function(datos){
        ...
        if (datos.destinatario != null){
            ...
            for (var i=0;i<dirs.length;i++){
                io.to(dirs[i]).emit('nuevo_mensaje',{user : datos.usuario, mensaje : datos.mensaje, destino: destinatario});
            }
            ...
            io.emit('nuevo_mensaje',{user : datos.usuario, mensaje : datos.mensaje , destino: 'todos'});
        }
