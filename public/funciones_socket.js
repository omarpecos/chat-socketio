...
socket.on('nuevo_mensaje',function(datos){
    ...
    if (datos.destino == 'todos'){
        divChatJquery.append(' <p class="msg_normal"><img src="https://img.icons8.com/dusk/16/000000/globe-earth.png">&nbsp;<strong>'+datos.user+' : </strong>'+datos.mensaje+'</p>');
    }else{
        if (datos.destino == usuario){
            divChatJquery.append(' <p class="msg_priv_recibido"><img style="position:relative;top:3px;" src="https://img.icons8.com/color/20/000000/unlock.png"><strong>'+datos.user+' : </strong>'+datos.mensaje+'</p>');
           
        }else{
            divChatJquery.append(' <p class="msg_priv_enviado"><img style="position:relative;top:3px;" src="https://img.icons8.com/color/20/000000/unlock.png"><strong>'+datos.user+' : </strong>'+datos.mensaje+'</p>');
        } 
    }
